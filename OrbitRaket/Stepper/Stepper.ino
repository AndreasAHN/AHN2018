...
const int Step1 = 28; //konstant for spole 1
const int Step2 = 31; //konstant for spole 1
const int Step3 = 30; //konstant for spole 2
const int Step4 = 29; //konstant for spole 2
int StepA=1;
int StepB=1;
int i=1;
int h=1;
