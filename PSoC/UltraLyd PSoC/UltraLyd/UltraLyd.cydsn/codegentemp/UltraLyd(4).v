// ======================================================================
// UltraLyd.v generated from TopDesign.cysch
// 11/13/2017 at 12:33
...
`ifdef WARP
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_sync_v1_0"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_sync_v1_0\cy_sync_v1_0.v"
`else
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_sync_v1_0"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_sync_v1_0\cy_sync_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_tff_v1_0"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_tff_v1_0\cy_tff_v1_0.v"
`else
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_tff_v1_0"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_tff_v1_0\cy_tff_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_Counter_v3_0"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_Counter_v3_0\B_Counter_v3_0.v"
`else
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_Counter_v3_0"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_Counter_v3_0\B_Counter_v3_0.v"
`endif

// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=21200, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=65535, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=false, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter, CY_INSTANCE_SHORT_NAME=Counter, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=Counter, )
...
`ifdef WARP
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\bI2C_v3_50"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\bI2C_v3_50\bI2C_v3_50.v"
`else
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\bI2C_v3_50"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\bI2C_v3_50\bI2C_v3_50.v"
`endif
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("5edf9881-0ec5-4866-ac71-8509558a26db"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__motorMode_net;
	wire [0:0] tmpFB_0__motorMode_net;
	wire [0:0] tmpIO_0__motorMode_net;
	wire [0:0] tmpINTERRUPT_0__motorMode_net;
	electrical [0:0] tmpSIOVREF__motorMode_net;

	cy_psoc3_pins_v1_10
		#(.id("8e2e4784-c834-40d2-967e-dc13efed5d23"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		motorMode
		 (.oe(tmpOE__motorMode_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__motorMode_net[0:0]}),
		  .io({tmpIO_0__motorMode_net[0:0]}),
		  .siovref(tmpSIOVREF__motorMode_net),
		  .interrupt({tmpINTERRUPT_0__motorMode_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__motorMode_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MOR_net;
	wire [0:0] tmpFB_0__MOR_net;
	wire [0:0] tmpIO_0__MOR_net;
	wire [0:0] tmpINTERRUPT_0__MOR_net;
	electrical [0:0] tmpSIOVREF__MOR_net;
	...
	cy_psoc3_pins_v1_10
		...
		MOR
		 (.oe(tmpOE__MOR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MOR_net[0:0]}),
		  .io({tmpIO_0__MOR_net[0:0]}),
		  .siovref(tmpSIOVREF__MOR_net),
		  .interrupt({tmpINTERRUPT_0__MOR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MOR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("29d2d5be-179f-4475-905b-05e7f710a4f4"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("250000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1a4c429d-cd10-4748-80ef-3a6ef7f74911"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d0a3be90-8a87-431e-9477-f373bf52ca05"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Sonic_Sensor_net;
	wire [0:0] tmpFB_0__Sonic_Sensor_net;
	wire [0:0] tmpINTERRUPT_0__Sonic_Sensor_net;
	electrical [0:0] tmpSIOVREF__Sonic_Sensor_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("264be2d3-9481-494b-8d9c-c1905a45e9cc"),
		  ...
		  .input_buffer_sel(2'b00))
		Sonic_Sensor
		 (.oe(tmpOE__Sonic_Sensor_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Sonic_Sensor_net[0:0]}),
		  .io({Net_516}),
		  .siovref(tmpSIOVREF__Sonic_Sensor_net),
		  .interrupt({tmpINTERRUPT_0__Sonic_Sensor_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sonic_Sensor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_47 = ~Net_517;


    assign Net_58 = Net_517 & Net_518;
    ...
    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_58)
    begin
        cy_tff_1 <= Net_516^Net_60;
    end
    assign Net_60 = cy_tff_1;
    // -- TFF End --


	cy_clock_v1_0
		#(.id("37862bdf-97c7-44f5-ab81-435ee59ef65d"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("35420b94-0f0c-4687-a32f-31c993dd2e5e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__DrejRun_net;
	wire [0:0] tmpFB_0__DrejRun_net;
	wire [0:0] tmpIO_0__DrejRun_net;
	wire [0:0] tmpINTERRUPT_0__DrejRun_net;
	electrical [0:0] tmpSIOVREF__DrejRun_net;

	cy_psoc3_pins_v1_10
		#(.id("c327a317-b2b4-462a-ba31-7dc2e91e6f17"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DrejRun
		 (.oe(tmpOE__DrejRun_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DrejRun_net[0:0]}),
		  .io({tmpIO_0__DrejRun_net[0:0]}),
		  .siovref(tmpSIOVREF__DrejRun_net),
		  .interrupt({tmpINTERRUPT_0__DrejRun_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DrejRun_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("afc7a0be-0b18-4d0b-90c2-9af5305a91b3"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Ekko_net;
	wire [0:0] tmpFB_0__Ekko_net;
	wire [0:0] tmpIO_0__Ekko_net;
	wire [0:0] tmpINTERRUPT_0__Ekko_net;
	electrical [0:0] tmpSIOVREF__Ekko_net;

	cy_psoc3_pins_v1_10
		#(.id("1710514f-039b-46a5-91b1-97993f670be1"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Ekko
		 (.oe(tmpOE__Ekko_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Ekko_net[0:0]}),
		  .io({tmpIO_0__Ekko_net[0:0]}),
		  .siovref(tmpSIOVREF__Ekko_net),
		  .interrupt({tmpINTERRUPT_0__Ekko_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ekko_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("713c4ee7-3fa8-4e13-abb5-4335f96c6098"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
